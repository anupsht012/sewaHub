      ...
      <AlertDialogContent className="max-w-md rounded-2xl border border-slate-200/80 bg-white p-6 shadow-lg">
        <AlertDialogHeader>
          ...
          <AlertDialogDescription className="text-xs sm:text-sm text-slate-500 mt-1">
            Are you sure you want to delete this review? This action cannot be undone and will permanently remove the feedback from the platform.
          </AlertDialogDescription>
        </AlertDialogHeader>
        ...
        <AlertDialogFooter className="mt-5 gap-2 sm:gap-0">
          <AlertDialogCancel
            disabled={loading}
            className="h-9 cursor-pointer text-xs font-semibold rounded-lg text-slate-700 border-slate-200 hover:bg-slate-50"
          >
            Cancel
          </AlertDialogCancel>
          <AlertDialogAction
            ...
            disabled={loading}
            className="h-9 text-xs cursor-pointer font-semibold rounded-lg bg-rose-600 hover:bg-rose-700 text-white gap-1.5"
          >
            {loading ? (
              <>
