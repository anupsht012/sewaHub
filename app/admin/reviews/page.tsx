      ...
      <div className="mx-auto max-w-7xl space-y-8">
        ...
        <div>
          <div className="flex items-center gap-2 mb-1">
            ...
            >
              <ShieldCheck className="h-3 w-3 mr-1 text-blue-600" /> Admin Management
            </Badge>
          </div>
          ...
          <p className="mt-1 text-xs sm:text-sm text-slate-500">
            Moderate and manage all customer ratings and feedback across the platform.
          </p>
        </div>
        ...
        {reviews.length === 0 ? (
          <Card className="rounded-2xl border border-slate-200/80 bg-white p-12 text-center shadow-2xs">
            ...
            <p className="text-xs text-slate-500 mt-1 max-w-sm mx-auto">
              There are currently no customer reviews posted on the platform.
            </p>
          </Card>
        ) : (
