...
import DeleteReviewButton from "@/components/customer/DeleteReviewButton";
import {
  Star,
  User,
  Calendar,
      ...
      <div className="mx-auto max-w-7xl space-y-8">
        ...
        <div>
          <div className="flex items-center gap-2 mb-1">
            ...
            >
              <Sparkles className="h-3 w-3 mr-1 text-blue-600" /> Review History
            </Badge>
          </div>
          ...
          <p className="mt-1 text-xs sm:text-sm text-slate-500">
            Track, view, and manage all the service reviews and feedback you have submitted.
          </p>
        </div>
        ...
        {reviews.length === 0 ? (
          <Card className="rounded-2xl border border-slate-200/80 bg-white p-12 text-center shadow-2xs">
            ...
            <p className="text-xs text-slate-500 mt-1 max-w-sm mx-auto">
              You haven't left any service reviews yet. When you rate and review a service, it will show up here.
            </p>
          </Card>
        ) : (
                  ...
                  <Table className="min-w-[800px] w-full">
                    <TableHeader className="bg-slate-50/80">
                      <TableRow className="border-b border-slate-100">
                        ...
                        <TableHead className="text-right font-semibold text-slate-700 text-xs whitespace-nowrap bg-slate-50">
                          Action
                        </TableHead>
                      </TableRow>
                    </TableHeader>
                    <TableBody>
                      {reviews.map((review) => {
                        const providerUser = review.service.provider.user;
